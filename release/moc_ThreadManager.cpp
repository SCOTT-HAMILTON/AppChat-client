...
#include "../../../../Desktop/AppChat-client/AppChat-client/ThreadManager.h"
...
QT_MOC_LITERAL(1, 14, 11), // "workerRData"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "emitWorkerD"

    },
    "ThreadManager\0workerRData\0\0emitWorkerD"
};
...
void ThreadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->workerRData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->emitWorkerD((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ThreadManager::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadManager::workerRData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadManager::workerRData(QString _t1)
{
